...
@Composable
fun SecondWhiteButton(onClick: () -> Unit, text: String, isEnabled: Boolean = true, isLoading: Boolean = false, modifier: Modifier) {
    if(!isLoading){
...
@Composable
fun PreviewSecondWhiteButton() {
    SecondWhiteButton(text = "SomethingText", isEnabled = true, onClick = {}, modifier = Modifier.fillMaxWidth())
}