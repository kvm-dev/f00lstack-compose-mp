...
buildConfig {
    ...
    // common config
    buildConfigField("String", "BASE_URL_PRODUCTION", "\"https://test.foolstack.ru/api/v1/\"")
    buildConfigField("String", "BASE_URL_TEST", "\"https://test.foolstack.ru/api/v1/\"")
...
kotlin {
    ...
    androidLibrary {
        namespace = "ru.kvmsoft.base.network"
        compileSdk = 36
        minSdk = 26
