...
kotlin {
    ...
    androidLibrary {
        namespace = "ru.kvmsoft.features.authorization.imp"
        compileSdk = 36
        minSdk = 26
    ...
    val xcfName = "features-authorization-impKit"
...
compose.resources {
    publicResClass = true
    packageOfResClass = "ru.kvmsoft.features.authorization.imp.ComposeResources"
