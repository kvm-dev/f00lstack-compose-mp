...
fun AuthorizationScreen(
    onAuthorized: () -> Unit, viewModel: AuthorizationScreenViewModel = koinViewModel()
) {
    ...
    when (state) {
                    ...
                    NonDismissibleBottomSheet(
                        ...
                        contentBottomSheet = {
                            Column(
                                ...
                                MainOrangeButton(
                                    isLoading = viewModel.emailLoading,
                                    isEnabled = true,
                        ...
                        contentBottomSheet = {
                            Column(
                                ...
                                EmailTextField(
                                    ...
                                    onChange = { viewModel.intentHandler(AuthorizationScreenIntents.SetEmailIntent(value = it)) },
                        ...
                        contentBottomSheet = {
                            Column(
                                ...
                                OtpTextField(
                                    ...
                                    onOtpTextChange = { viewModel.intentHandler(
                                        AuthorizationScreenIntents.SetOtpIntent(value = it)) },
        ...
        is AuthorizationScreenViewState.ErrorState -> {
            val errorState = state as AuthorizationScreenViewState.ErrorState
            if ((errorState).error == AuthorizationErrors.CONNECTION_NOT_FOUND) {
                ...
                BaseErrorBottomSheet(
                    ...
                    actionMain = { closeApp() },
                    actionSecond = { viewModel.intentHandler(AuthorizationScreenIntents.OpenChatIntent) },
                    onDismiss = { closeApp() })
            }
        }
    }
